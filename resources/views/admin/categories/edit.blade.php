                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="icon" class="block mt-1 w-full" type="text" name="icon" :value="old('icon', $category->icon)" required placeholder="mdi-home" />
                            ...
                            <div class="mt-2 flex items-center space-x-2">
                                ...
                                @svg($category->icon ?? 'mdi-help', 'w-8 h-8 text-blue-600 dark:text-blue-400')
                            </div>
