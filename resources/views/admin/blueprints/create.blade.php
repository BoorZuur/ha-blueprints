                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.blueprints.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-textarea id="description" class="block mt-1 w-full" name="description" rows="4" required>{{ old('description') }}</x-textarea>
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="show" value="1" {{ old('show') ? 'checked' : '' }} class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
